<?php
if (!class_exists('GWSSCS_Update_Checker')) {

    class GWSSCS_Update_Checker {
        ...
        public function __construct() {
            $utility = Gwsscs_updater_utility();
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'Gwsscs_plugin_updates';
